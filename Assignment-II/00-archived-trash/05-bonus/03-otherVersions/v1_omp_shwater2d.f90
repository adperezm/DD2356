...
program shwater2d
  ...
  ! Check that open mp works
  !omp parallel private(id)
  !   id=omp_get_thread_num()
  !   write(*,*) 'Thread ',id,' Active'  
  !omp end parallel
  maxt=omp_get_max_threads()
  
  write(*,*) '------------------------------------'
  write(*,*) 'Running with ',maxt,' Threads'
...
subroutine laxf_scheme_2d(Q, l, m, n, dx, dy, dt, fx, fy)
  ...
  !
  !$omp parallel do private(i,j,ffx,nFx)
  do i=2,n
     call fx(Q(:,:,i), ffx, l, m)
     do j=2,m
  ...
  !
  !$omp parallel do private(i,j,ffy,nFy)
  do i=2,m
     call fy(Q(:,i,:), ffy, l, n)
     do j=2,n
